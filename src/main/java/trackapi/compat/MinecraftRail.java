...
public class MinecraftRail implements ITrack {
	...
	public Vec3d getNextPosition(Vec3d currentPosition, Vec3d motion) {
		...
		Vec3d pos_vec = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
		Vec3d posRelativeToCenter = pos_vec.subtract(currentPosition).add(trackCenter);
		...
		Vec3d newPosition = pos_vec.add(trackCenter);
